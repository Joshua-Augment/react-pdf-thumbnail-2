...
exports.createCanvas = exports.createImage = exports.getExtension = exports.dataURLtoFile = void 0;
...
const createImage = (canvas, filename) => {
    ...
    const file = success ? (0, exports.dataURLtoFile)(image, filename) : null;
    const imageUrl = success ? URL.createObjectURL(file) : null;
    return [success, file, image, imageUrl];
};
exports.createImage = createImage;
const createCanvas = (page, config) => __awaiter(void 0, void 0, void 0, function* () {
    try {
